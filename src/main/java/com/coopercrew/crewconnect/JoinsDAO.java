...
public class JoinsDAO extends DataAccessObject{
    ...
    public ArrayList<String> getAllGroupChatsWithUser(long id){
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(GET_ALL_GROUPCHATS_WITH_USER);) {
            ...
            while(rs.next()) {
                ...
                groupchatList.add(groupchat.toString());
            }
    ...
    public ArrayList<String> getMessagesFromUser(long id){
    ...
    public ArrayList<String> getAllUsersInGroupChat(long id){
        User user = new User();
    ...
    public ArrayList<String> getMessagesInGroupChat(long id){
        Message message = new Message();
        ArrayList<String> messageList = new ArrayList<String>();
